...
// .wrangler/tmp/pages-JS0IPj/functionsWorker-0.08267597446063046.mjs
...
__name(getAccessToken2, "getAccessToken2");
__name2(getAccessToken2, "getAccessToken");
...
__name2(lookupCustomerInCRM, "lookupCustomerInCRM");
...
__name2(lookupInGoogleSheets, "lookupInGoogleSheets");
...
__name2(buildZohoPayload, "buildZohoPayload");
...
__name(getAccessToken3, "getAccessToken3");
__name2(getAccessToken3, "getAccessToken");
...
__name2(resolveTargetUrl, "resolveTargetUrl");
var CORS_HEADERS6 = {
  "Access-Control-Allow-Origin": "*",
...
var onRequestPost6 = /* @__PURE__ */ __name2(async ({ request, env }) => {
  let body = {};
  try {
    body = await request.json();
  } catch {
...
var onRequestPost7 = /* @__PURE__ */ __name2(async ({ request, env }) => {
  const corsHeaders = {
...
// .wrangler/tmp/bundle-BkN0mY/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-BkN0mY/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.08267597446063046.js.map
